...
generate-swagger:   ## generate swagger docs from the proto files
	cd proto; $(PROTOC) -I/usr/local/include -I. -Imodel -I"$(GOPATH)/src" -I"../vendor/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis" --swagger_out=logtostderr=true:../swagger/ *.proto
